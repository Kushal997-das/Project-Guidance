...
Details:- This is a simple calculator app using flutter and simple widgets . It is made using the flutter UI and only 2 files is been used for it  . All of the code is in the working file and main.dart is used to run the application . 
