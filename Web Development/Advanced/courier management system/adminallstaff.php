...
<div class="container" style="margin-top:90px;width:70%;">
<table class="table">
  ...
  <tr>
    ...
    <td><button type="button" class="btn btn-danger" ><a href="adminallstaff.php?id=<?php echo $row["id"]; ?>" style="color:#fff;">Delete</a> </button></td></form>
    </tr>
  </tbody>
<?php
}
