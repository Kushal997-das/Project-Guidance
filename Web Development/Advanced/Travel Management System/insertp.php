		...
		<form action="" method="GET">
			<!-- <div class="contact-form" method="GET" action=""> -->
				...
				<div class="form-group py-2">
				  ...
				  <div class="col-sm-10">
					<input type="phone" class="form-control" id="pmobile" placeholder="Enter PASSENGER MOBILE" name="pmobile">
				  </div>
				</div>
				<div class="form-group py-2"> 
...
if($_GET['Submit'])
{
	...
	if($pn != "" && $pna != "" && $pad != "" && $pmb != "" && $bno != "")
	{
		$query = "INSERT INTO PASSENGER VALUES ('$pn','$pna','$pmb','$pad','$bno')";
