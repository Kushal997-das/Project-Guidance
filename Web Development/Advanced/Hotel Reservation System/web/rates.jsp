...
<%
    ...
    String query = "SELECT rate.rate_id, rate.comment, rate.rate, rate.hotel_id, rate.user_id, user.user_id,user.display_name FROM rate INNER JOIN user ON user.user_id = rate.user_id";
...
<html>
    <head>
        ...
        <title>Rates and Comments</title>
        <style>
            *{
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="container">
            <h3 style="margin: 30px;">Rates and Comments</h3>
