 ...
 * @public
 */
export declare type LetrecValue<T> = {
 ...
 * @public
 */
export declare type LetrecTypedBuilder<T> = (tie: LetrecTypedTie<T>) => LetrecValue<T>;
/**
 ...
 * @public
 */
export declare type LetrecLooselyTypedTie = (key: string) => Arbitrary<unknown>;
/**
 ...
 * @public
 */
export declare type LetrecLooselyTypedBuilder<T> = (tie: LetrecLooselyTypedTie) => LetrecValue<T>;
/**
